// looking on os dev wiki, you can see which parts of the mem are occupied by the bios
// and which are free to be used
#pragma once
...
#define MEMORY_FAT_ADDR     ((void far*)0x20000)
